...
export const STRINGS = {
  en: {
    ...
    bliqkFix:"BLIQK reads every email for you.", bliqkFixDesc:"Automatically sorted by urgency, intent, and risk. Legal threats surface in seconds. Hot leads never go cold.",
    ...
    themeLabel:"Theme",
    inbox:"Inbox", capture:"Smart Capture", integrations:"Integrations",
    usage:"Usage & Costs", settings:"Settings",
    seeWhat:"SEE WHAT NEEDS ACTION", criticalAlert:"Requires immediate action",
    priorityInbox:"Priority Inbox", all:"All", critical:"Critical",
    issues:"Issues", leads:"Leads", unread:"Unread",
    ...
    themeSection:"Theme", fontSection:"Font size", contrastSection:"Contrast",
    langSection:"Language", standardContrast:"Standard", highContrast:"⚡ High contrast",
  ...
  es: {
    ...
    bliqkFix:"BLIQK lee cada email por ti.", bliqkFixDesc:"Ordenado automáticamente por urgencia, intención y riesgo. Las amenazas legales aparecen en segundos. Los leads calientes nunca se enfrían.",
    ...
    themeLabel:"Tema",
    inbox:"Bandeja", capture:"Captura rápida", integrations:"Integraciones",
    usage:"Uso y Costos", settings:"Configuración",
    seeWhat:"VE LO QUE NECESITA ACCIÓN", criticalAlert:"Requiere acción inmediata",
    priorityInbox:"Bandeja prioritaria", all:"Todos", critical:"Críticos",
    issues:"Reclamos", leads:"Leads", unread:"Sin leer",
    ...
    themeSection:"Tema", fontSection:"Tamaño de fuente", contrastSection:"Contraste",
    langSection:"Idioma", standardContrast:"Estándar", highContrast:"⚡ Alto contraste",
...
interface SettingsCtx {
  ...
  t: Theme; fs: { base:number; sm:number; xs:number; label:string }; s: typeof STRINGS["en"];
}
...
export function SettingsProvider({ children }: { children: ReactNode }) {
  ...
  const save = (patch: object) => {
    try { localStorage.setItem("bliqk_v4", JSON.stringify({ ...JSON.parse(localStorage.getItem("bliqk_v4")||"{}"), ...patch })); } catch {}
  };
